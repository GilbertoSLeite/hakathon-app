          ...
          <q-scroll-area style="height: 100%">
            <q-list padding>
              ...
              >
                ...
                <q-item-section> Visão Individual </q-item-section>
              </q-item>
...
import { createIndividualGoal } from 'src/services/goals-service/crud-goals-service';
...
export default defineComponent({
  ...
  setup() {
    return {
      model: ref(null),
      options: ['Metas Globais', 'Metas Setoriais', 'Metas Individuais'],
    };
  },
  methods: {
    logoutNotify() {
    ...
    async registerGoal() {
      try {
        ...
        const response = await createIndividualGoal(data);
